    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold mb-2">Couldn't load the admin dashboard</h2>
          <p className="text-gray-500 mb-4">We're having trouble fetching platform data right now. Please try again in a moment.</p>
          <button
