...
const Hero = () => {
  return (
    <section className="bg-gradient-to-br from-green-50 to-white min-h-[90vh] flex items-center">
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4 mt-8">
            ...
            <button className="bg-green-700 text-white px-7 py-3 rounded-xl hover:bg-green-800 transition">
              Hire a House Help
            </button>

            <button className="border border-green-700 text-green-700 px-7 py-3 rounded-xl hover:bg-green-50 transition">
              Find a Job
            </button>
